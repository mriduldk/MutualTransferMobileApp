...
import com.codingstudio.mutualtransfer.model.auth.UserType
...
class UserSetUserTypeFragment : Fragment() {
    ...
    private fun setOnClickListeners() {
        ...
        binding.btnSaveAndProceed.setOnClickListener {
            ...
            if (userTypeSelected) {
                SharedPref().setString(localContext, Constants.user_type, userType)

                if (userType == "TET Teacher") {
        ...
        val adapter = object : ArrayAdapter<UserType>(localContext, R.layout.layout_user_type_select, userTypeList) {
            ...
            override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
                ...
                linearLayout.setOnClickListener {
                    ...
                    userType = userTypeList[position].text
